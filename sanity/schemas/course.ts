...
export const courseSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'outcomes',      type: 'array',   title: "What you'll learn", of: [{ type: 'string' }], description: 'Short bullets shown on the course page' }),
    ...
    defineField({ name: 'audience',      type: 'text',    title: 'Who is this for',  rows: 3 }),
